...
@section('title', $instructor['name'].' - Eduleb')
			  ...
			  <div class="col-lg-12 col-sm-12 col-xs-12">
					<div class="single_agent">
						<div class="single_agent_image">
							<img src="{{ asset('assets/img/'.$instructor['image']) }}" class="img-fluid" alt=""/>
						</div>
						<div class="single_agent_content">
							...
							<div class="sth_det2">
								<span class="ti-file"> <u>{{ $instructor['courses'] }} Course</u></span>
								<span class="ti-user"> <u>{{ $instructor['students'] }} Student</u></span>
							</div>
						</div>
						<div class="agent_social">
							<ul class="list-inline">
								<li><a href="#" class="top_f_facebook"><img src="{{ asset('assets/img/fb.svg') }}" alt="" /></a></li>
								<li><a href="#" class="top_f_facebook"><img src="{{ asset('assets/img/pn.svg') }}" alt="" /></a></li>
								<li><a href="#" class="top_f_facebook"><img src="{{ asset('assets/img/ins.svg') }}" alt="" /></a></li>
							</ul>
						</div>
					</div><!--- END SINGLE ITEM -->
			  </div><!--- END COL -->
