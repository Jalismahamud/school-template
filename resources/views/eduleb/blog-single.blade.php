...
@section('title', $post['title'].' - Eduleb')
				...
				<div class="col-lg-7 col-sm-12 col-xs-12">
					<div class="arti_single">
						<div class="arti_img_two">
							<img src="{{ asset('assets/img/'.$post['image']) }}" class="img-fluid" alt="Blog image" />
						</div>
						<div class="arti_content ">
							<p>I almost couldn&rsquo;t believe it was real! For my first test I had generate some website copy for me. I provided about 50 words to describe my business along with my business name. generated two variants of copy each with several paragraphs of professional sounding copy. I immediately shared the results with a friend who couldn&rsquo;t believe it was written by an AI. is worth every Yaley and then some. Describe my business along with my business name. generated two variants of copy each with several paragraphs of professional sounding copy. I immediately shared the results with a friend who couldn&rsquo;t believe it was written by an AI. is worth every Yaley and then some!</p>
						</div>
						<div class="arti_sp">
							<h2>{{ $post['title'] }}</h2>
							<img src="{{ asset('assets/img/blog/1.png') }}" class="img-fluid" alt="Blog image" />
							<p>I immediately shared the results with a friend who couldn&rsquo;t believe it was written by an AI. is worth every Yaley and then some. Describe my business along with my business name. generated two variants of copy each with several paragraphs of professional sounding copy. I immediately shared the results with a friend who couldn&rsquo;t believe it was written by an AI. is worth every Yaley and then some!</p>
						</div>
						<div class="share_sp">
							<h4>Share</h4>
							<ul>
				...
				<div class="col-lg-5 col-sm-12 col-xs-12">
					...
					<div class="sidebar-post">
						...
						<div class="single_popular">
							<a href="{{ route('blog.single', 1) }}"><img src="{{ asset('assets/img/blog/blog-1.png') }}" alt="" /></a>
							<h5><a href="{{ route('blog.single', 1) }}">Supercharging Your SEO Game with AI Writing Assistants</a></h5>
						</div><!-- END SINGLE POPULAR POST -->
						<div class="single_popular">
							<a href="{{ route('blog.single', 2) }}"><img src="{{ asset('assets/img/blog/blog-2.png') }}" alt="" /></a>
							<h5><a href="{{ route('blog.single', 2) }}">AI Writing Assistants and the Future of Content Marketing</a></h5>
						</div><!-- END SINGLE POPULAR POST -->
						<div class="single_popular">
							<a href="{{ route('blog.single', 3) }}"><img src="{{ asset('assets/img/blog/blog-3.png') }}" alt="" /></a>
							<h5><a href="{{ route('blog.single', 3) }}">Enhancing Your E-commerce Store With AI Writing Assistants.</a></h5>
						</div><!-- END SINGLE POPULAR POST -->
						<div class="single_popular">
							<a href="{{ route('blog.single', 1) }}"><img src="{{ asset('assets/img/blog/blog-4.png') }}" alt="" /></a>
							<h5><a href="{{ route('blog.single', 1) }}">Building your content strategy cannot get easier than this.</a></h5>
						</div><!-- END SINGLE POPULAR POST -->
						<div class="single_popular">
							<a href="{{ route('blog.single', 2) }}"><img src="{{ asset('assets/img/blog/blog-5.png') }}" alt="" /></a>
							<h5><a href="{{ route('blog.single', 2) }}">This is the only read you would need before sitting down to prepare</a></h5>
						</div><!-- END SINGLE POPULAR POST -->
					...
					<div class="sidebar-post">
						...
						<div class="sidebar-banner">
							<a href="#"><img src="{{ asset('assets/img/blog/banner.jpg') }}" class="img-fluid" alt="" /></a>
						</div><!-- END SOCIAL MEDIA POST -->
					</div><!-- END SIDEBAR POST -->
				</div><!--- END COL -->
			</div><!-- END ROW-->
