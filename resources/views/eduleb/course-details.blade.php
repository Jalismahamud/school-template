...
@section('title', $course['title'].' - Eduleb')
				...
				<div class="row">
					<div class="col-lg-8 col-sm-8 col-xs-12">
						<div class="single_event_single">
							<img alt="" class="img-fluid" src="{{ asset('assets/img/'.$course['image']) }}"/>
                                        ...
                                        <div class="overview text-center">
                                            <div class="instructor-item">
                                                <div class="instructor-thumb">
                                                    <a href="#0"><img src="{{ asset('assets/img/ins-details.png') }}" alt="instructor"></a>
                                                </div>
                                        ...
                                        <div class="client-review">
                                            <div class="review-comments">
                                                ...
                                                <ul class="review-contents">
                                                    <li>
                                                        <div class="thumb">
                                                            <img src="{{ asset('assets/img/client04.png') }}" alt="course">
                                                        </div>
                                                        <div class="cont">
                                                    ...
                                                    <li>
                                                        <div class="thumb">
                                                            <img src="{{ asset('assets/img/client02.png') }}" alt="course">
                                                        </div>
                                                        <div class="cont">
                                                    ...
                                                    <li>
                                                        <div class="thumb">
                                                            <img src="{{ asset('assets/img/client03.png') }}" alt="course">
                                                        </div>
                                                        <div class="cont">
					...
					<div class="col-lg-4 col-sm-4 col-xs-12">
						<div class="course_features">
							...
							<ul>
								<li><i class="fa fa-calendar"></i> Course duration <b>{{ $course['duration'] }}</b></li>
								<li><i class="fa fa-user"></i> Total Lectures <b>{{ $course['lessons'] }}</b></li>
						...
						<div class="related_course">
							...
							<div class="single_rc">
								<div class="rc_img">
									<img src="{{ asset('assets/img/rc-1.png') }}" alt="" />
								</div>
							...
							<div class="single_rc">
								<div class="rc_img">
									<img src="{{ asset('assets/img/rc-2.png') }}" alt="" />
								</div>
								<i class="fa fa-star"></i>
								<i class="fa fa-star"></i>
								<i class="fa fa-star"></i>
